...
```bash
pip install build
python -m build          # produces dist/mirror_url-3.1.41-py3-none-any.whl
```
...
/opt/mirror-url/bin/pip install /tmp/mirror_url-3.1.41-py3-none-any.whl
...
```bash
/opt/mirror-url/bin/pip install "/tmp/mirror_url-3.1.41-py3-none-any.whl[fast]"
```
...
```bash
pip install "git+https://github.com/bpodlipnik/mirror-url.git@v3.1.41"
# private repo over SSH:
pip install "git+ssh://git@github.com/bpodlipnik/mirror-url.git@v3.1.41"
```

### As an isolated CLI with pipx

```bash
pipx install /tmp/mirror_url-3.1.41-py3-none-any.whl
# or:  pipx install "git+https://github.com/bpodlipnik/mirror-url.git@v3.1.41"
```
...
COPY dist/mirror_url-3.1.41-py3-none-any.whl /tmp/
RUN pip install --no-cache-dir "/tmp/mirror_url-3.1.41-py3-none-any.whl[fast]"
